...
class ShopwareProductionProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '5ba35e9269e2419a0e064540bf74b795'), array('hashed_directory_perm' => 505, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/home/gam/var/cache/production_201510221322/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = $this->get('db_factory')->factory('pdo_mysql', array('username' => 'root', 'password' => 'rahasia', 'dbname' => 'shop1', 'host' => 'localhost', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/home/gam/var/cache/production_201510221322/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/home/gam/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'fileCacheDir' => '/home/gam/var/cache/production_201510221322/doctrine/filecache', 'attributeDir' => '/home/gam/var/cache/production_201510221322/doctrine/attributes', 'proxyDir' => '/home/gam/var/cache/production_201510221322/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), $this->get('hooks'));
    }
    protected function getModelsService()
    {
        ...
        return $this->services['models'] = $this->get('model_factory')->factory($a, $this->get('modelconfig'), $this->get('loader'), $this->get('db_connection'), '/home/gam', $this->get('modelannotations'));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/home/gam/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/home/gam/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/home/gam');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/home/gam/snippets/');
    }
    ...
    {
        return $this->services['shopware_media.media_service_factory'] = new \Shopware\Bundle\MediaBundle\MediaServiceFactory($this, array('backend' => 'local', 'strategy' => 'md5', 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'path' => '/home/gam'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_media.strategy_factory'] = new \Shopware\Bundle\MediaBundle\Strategy\StrategyFactory(array('backend' => 'local', 'strategy' => 'md5', 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'path' => '/home/gam'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/home/gam', $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.plugin_manager'] = new \Shopware\Bundle\PluginInstallerBundle\Service\InstallerService($this->get('models'), $this->get('plugins'), '/home/gam');
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/home/gam', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/home/gam', $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/home/gam', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/gam',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/home/gam/var/cache/production_201510221322',
            'kernel.logs_dir' => '/home/gam/var/log',
            ...
            'shopware.cdn.adapters.local.path' => '/home/gam',
            ...
            'shopware.db.password' => 'rahasia',
            'shopware.db.dbname' => 'shop1',
            ...
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/home/gam/var/cache/production_201510221322/templates',
                'compileDir' => '/home/gam/var/cache/production_201510221322/templates',
            ),
            ...
            'shopware.template.cachedir' => '/home/gam/var/cache/production_201510221322/templates',
            'shopware.template.compiledir' => '/home/gam/var/cache/production_201510221322/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/home/gam/var/cache/production_201510221322/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/home/gam/var/cache/production_201510221322/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '5ba35e9269e2419a0e064540bf74b795',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/home/gam/var/cache/production_201510221322/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '5ba35e9269e2419a0e064540bf74b795',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/home/gam/var/cache/production_201510221322/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/home/gam/var/cache/production_201510221322/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/home/gam/var/cache/production_201510221322/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'fileCacheDir' => '/home/gam/var/cache/production_201510221322/doctrine/filecache',
                'attributeDir' => '/home/gam/var/cache/production_201510221322/doctrine/attributes',
                'proxyDir' => '/home/gam/var/cache/production_201510221322/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.filecachedir' => '/home/gam/var/cache/production_201510221322/doctrine/filecache',
            'shopware.model.attributedir' => '/home/gam/var/cache/production_201510221322/doctrine/attributes',
            'shopware.model.proxydir' => '/home/gam/var/cache/production_201510221322/doctrine/proxies',
